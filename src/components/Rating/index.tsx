...
export class Rating extends React.Component {
  ...
  //     <div className="rating">
  //       <div className="rating__items">
  //         <input className="rating__item" type="radio" name="rating" aria-label="Terrible" value={1} defaultChecked={true} />
  //         <input className="rating__item" type="radio" name="rating" aria-label="Tolerably" value={2} />
  //         <input className="rating__item" type="radio" name="rating" aria-label="Fine" value={3} />
  //         <input className="rating__item" type="radio" name="rating" aria-label="Okay" value={4} />
  //         <input className="rating__item" type="radio" name="rating" aria-label="Great" value={5} />
  //       </div>
  //     </div>
  //   )
  // }
